...
require "spec_helper"
require_relative "../../../../lib/services/commands/left"
...
RSpec.describe Commands::Left do
  ...
  context "when heading north" do
    ...
    it "rotates robot to the west" do
      expect { run_command }.to change(robot, :direction).from(90.0).to(0.0)
    end
  end
  ...
  context "when heading east" do
    ...
    it "rotates robot to the north" do
      expect { run_command }.to change(robot, :direction).from(180.0).to(90.0)
    end
  end
  ...
  context "when heading south" do
    ...
    it "rotates robot to the east" do
      expect { run_command }.to change(robot, :direction).from(270.0).to(180.0)
    end
  end
  ...
  context "when heading west" do
    ...
    it "rotates robot to the south" do
      expect { run_command }.to change(robot, :direction).from(0.0).to(270.0)
    end
  end
end
